...
type JobGateway interface {
	GetJob(context.Context, string) (domain.JobRecord, error)
...
type ModelCatalog interface {
	...
	Capabilities(context.Context) (domain.Capabilities, error)
	Ready(context.Context) error
}
type EvaluationReader interface {
	Evaluations(context.Context, domain.ListFilter) (domain.EvaluationList, error)
	Evaluation(context.Context, string) (domain.EvaluationReport, error)
	DataQuality(context.Context) (domain.DataQualityReport, error)
}
